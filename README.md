...
A API REST foi criada com Java e Spring Boot, o banco de dados com ORM e o front end com ReactJS. A integração com SMS foi feita via plataforma TWilio. A implantação na nuvem foi via Heroku e Netlify.

Site da aplicação: [Minha aplicação](https://dsmeta-alvaro.netlify.app)

Projeto foi feito seguindo o evento da Semana Spring React promovida pela DevSuperior.
